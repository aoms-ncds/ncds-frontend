      ...
      <Page size="A4">
        ...
        <div style={{ marginTop: 120 }}>
          ...
          <View style={{ ...styles.box, marginTop: 15 }}>
            ...
            <Text style={{ ...styles.text, marginTop: 10, left: 200 }}>
              Request Raised Date :
            </Text>
            <Text style={{ ...styles.text, marginTop: 30, left: 20 }}>
              Fund Release date:
            </Text>
            <Text style={{ ...styles.text, marginTop: 30, left: 200 }}>
              FR Reconciled Date:
            </Text>
          </View>
        </div>
        ...
        <div style={{ marginTop: 60 }}>
          ...
          <View style={{ ...styles.box4, marginTop: 15 }}>
            ...
            <Text style={{ ...styles.text, marginTop: 50, left: 20 }}>
              Transfer Type :
            </Text>
            <Text style={{ ...styles.text, marginTop: 50, left: 200 }}>
              Transaction Id :
            </Text>
          </View>
        </div>
        ...
        <div style={{ marginTop: 120 }}>
          <View style={{ ...styles.box2, marginTop: 15 }}>
            <Text style={{ ...styles.text, marginTop: 10, left: 20 }}>
              Santioned Amount in Words :
            </Text>
          </View>
        </div>

        <div style={{ marginTop: 80 }}>
          <Text style={{ ...styles.text, marginTop: 1, left: 50 }}>
            E Signature
          </Text>
          <Text style={{ ...styles.text, marginTop: 1, left: 410 }}>
            E Signature are protected
          </Text>
          ...
          <View
            style={{ ...styles.box5, marginTop: 15, left: 410, width: 130 }}
          ></View>
          ...
          <Text
            style={{ ...styles.text1, left: 410, fontSize: 10, marginTop: 130 }}
          >
            NAME
          </Text>
          ...
          <Text
            style={{ ...styles.text2, left: 410, fontSize: 10, marginTop: 144 }}
          >
            ADMINISTRATOR
          </Text>
          <Text
            style={{ ...styles.text2, left: 410, marginTop: 158, fontSize: 10 }}
          >
            SACTIONING AUTHORITY
          </Text>
        </div>
