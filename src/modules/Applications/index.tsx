    ...
    <CommonPageLayout title="Application Dashboard">
      <Grid container spacing={3}>
        <Grid item xs={6} md={3} xl={3}>
          <FRCountCard count={ApplicationCreatedCount?.toString()} secondaryText={'Created / Waiting for HR'} color="#fff" />
        </Grid>
        <Grid item xs={6} md={3} xl={2}>
          <FRCountCard count={ApplicationActiveCount?.toString()} secondaryText={'Active'} color={'#fff'} />
        </Grid>
        <Grid item xs={6} md={3} xl={2}>
          <FRCountCard count={ApplicationApprovedCount?.toString()} secondaryText={'Approved'} color={'#fff'} />
        </Grid>
        <Grid item xs={6} md={3} xl={2}>
          <FRCountCard count={ApplicationRejectedCount?.toString()} secondaryText={'Rejected'} color={'#fff'} />
        </Grid>
      </Grid>
      <br />
      <Grid container spacing={3}>
