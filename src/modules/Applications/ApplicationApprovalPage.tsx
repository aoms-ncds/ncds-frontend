      ...
      <Card variant="outlined">
        <CardContent>
          <Grid container spacing={2}>
            <Grid item md={12}>
              <Typography variant="h5" component="h2"> Requested By: {applications?.name} </Typography>
              <Typography variant="h5" component="h2"> Reason: {applications?.reason} </Typography>

              <Typography variant="h5" component="h2">
              File: &nbsp; <Button component="span" variant="outlined"> View File </Button>
              </Typography>
            </Grid>
          </Grid>
        </CardContent>
