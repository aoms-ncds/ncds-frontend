    ...
    <CommonPageLayout title="Workers Dashboard">
      <Grid container spacing={3}>
        <Grid item xs={12} md={4} xl={3}>
          <ButtonCard secondaryText="Manage Workers" count={workersCount?.toString()} color="#AC92EC" targetRoute="/workers/manage" />
        </Grid>
        ...
        />
        <Grid item xs={12} md={4} xl={3}>
          <ButtonCard secondaryText="In Process workers" count={rejectedWorkersCount?.toString()} color="#8CC152 " targetRoute="/workers/reject" />
        </Grid>

        <Grid item xs={12} md={4} xl={3}>
          <ButtonCard secondaryText="Deactivated Workers" count={deactivateWorkersCount?.toString()} color="#ED5565" targetRoute="/workers/deactivated" />
        </Grid>
      </Grid>
    </CommonPageLayout>
  );
