...
const WorkersDashboard = () => {
  ...
  return (
    <CommonPageLayout title="AssociatesDashboard">
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={4} xl={3}>
          <FRCountCard
            icon={
              <img
                src="/mod_icons/Total Active AssociatesCounter Card.png"
                alt="Logo"
            ...
            secondaryText="Total Associates "
            color="#fff"
          />        </Grid>
        <Grid item xs={12} md={4} xl={3}>
          <FRCountCard icon={<img src="/mod_icons/Total Active AssociatesCounter Card.png"
            alt="Logo" style={{ width: '70px', height: '70px' }} />} count={activeWorker?.toString()} secondaryText="Active Associates " color="#fff" />
        </Grid>
        <Grid item xs={12} md={4} xl={3}>
      ...
      >
        ...
        <CardContent>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={4} xl={3}>
              <ButtonCard secondaryText="Manage Associates " icon={<img src="/mod_icons/manageWorker.jpeg" alt="Logo" style={{ width: '70px', height: '70px' }} />}
            ...
            />
            <Grid item xs={12} md={4} xl={3}>
              <ButtonCard secondaryText="In Process Associates " icon={<img src="/mod_icons/Process Worker.jpeg" alt="Logo" style={{ width: '70px', height: '70px' }} />}
                count={rejectedWorkersCount?.toString()} color="#fff" targetRoute="/workers/reject" />
            </Grid>

            <Grid item xs={12} md={4} xl={3}>
              <ButtonCard secondaryText="Deactivated Associates " icon={<img src="/mod_icons/Deactivated Associates .jpeg" alt="Logo" style={{ width: '70px', height: '70px' }} />}
                count={deactivateWorkersCount?.toString()} color="#fff" targetRoute="/workers/deactivated" />
            </Grid>
            <Grid item xs={12} md={4} xl={3}>
              <ButtonCard secondaryText="Disapprove Associates " icon={<img src="/mod_icons/Deactivated Associates .jpeg" alt="Logo" style={{ width: '70px', height: '70px' }} />}
