  ...
  return (
    <CommonPageLayout title="HR Dashboard">
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6} xl={3}>
          <DashboardCardButton primaryText="Manage Workers" secondaryText={workersCount?.toString()} color="#0dcaf0" targetRoute="/workers" />
        </Grid>
        <Grid item xs={12} md={6} xl={3}>
          <DashboardCardButton primaryText="Approve New Worker" secondaryText={unapprovedWorkersCount?.toString()} color="#8833ff" targetRoute="/workers/approve" />
        </Grid>
      </Grid>
    </CommonPageLayout>
  );
