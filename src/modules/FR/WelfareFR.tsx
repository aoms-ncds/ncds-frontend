...
const WelfareFR = () => {
  ...
  const [statusFilter1, setStatusFilter1] = useState<'worker' | 'child'|'all'>('all'); // default WFA: Waiting for access or Reverted
  useEffect(() => {
                    ...
                    {/* <Grid item md={4}>
                      <FormControl>
                        <RadioGroup
                          aria-labelledby="Filter"
                          value={statusFilter1}
                          onChange={(e) => setStatusFilter1(e.target.value as 'worker' | 'child')}
                          name="Filter"
                          row
                        >
