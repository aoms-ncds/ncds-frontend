import { Container, CardContent,
  ...
  TableCell, TableBody, DialogTitle, TableContainer, Stack } from '@mui/material';
import {
                ...
                <Autocomplete
                  ...
                  onChange={(e, selectedMainCategory) => {
                    if (selectedMainCategory) {
                      setParticularDetails((particularDetails) => ({ ...particularDetails, mainCategory: selectedMainCategory.name }));
              ...
              <Grid item xs={12} md={6} lg={6}>
                <FormControl variant="outlined" fullWidth>
                  <TextField
                    ...
                    onChange={(e) =>
                      props.onChange({ ...props.value, sanctionedAmount: Number(e.target.value) })
                    }
                    fullWidth
                  />
                </FormControl>
                        ...
                        <Autocomplete
                          ...
                          onChange={(_e, selectedSubCategory1) => {
                            if (selectedSubCategory1) {
                              setParticularDetails((particularDetails) => ({ ...particularDetails, subCategory1: selectedSubCategory1.name }));
                      ...
                      <Grid item md={12}>
                        <Autocomplete
                          ...
                          onChange={(_e, selectedSubCategory2) => {
                            if (selectedSubCategory2) {
                              setParticularDetails((particularDetails) => ({ ...particularDetails, subCategory1: selectedSubCategory2.name }));
                          ...
                          onChange={(e, selectedSubCategory3) => {
                            if (selectedSubCategory3) {
                              setParticularDetails((particularDetails) => ({
                                ...particularDetails, subCategory1: selectedSubCategory3.name,
                      ...
                      <Grid item md={12}>
                        <Autocomplete
                          ...
                          onChange={(e, selectedMonth) => {
                            if (selectedMonth) {
                              setParticularDetails((particularDetails) => ({ ...particularDetails, month: selectedMonth }));
                            }
                          }}
