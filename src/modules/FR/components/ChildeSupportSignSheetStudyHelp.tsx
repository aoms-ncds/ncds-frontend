...
const ChildeSupportSignSheetStudyHelp = (props: { frNo: any; data: Child[] | null; total: number; month: string | null; subDiv?: any | null }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <View style={[styles.c5, isLastInGroup ? styles.noBottomBorderForGroup : styles.withBorder]}>
                        <Text style={[styles.tableCell]}>{row.studyHelp ?? ''}</Text>
                      </View>
...
export default ChildeSupportSignSheetStudyHelp;
