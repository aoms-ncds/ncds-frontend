...
const PDFTemplateCustomChild = (props:any) => {
        ...
        <View style={styles.tableContainer} >
          ...
          {props.rowData?.map((row: any, index: number) => (
            <View style={styles.tableRow} key={row._id}>
              ...
              {props.headers.includes('Child Code') && (
                <>
                  <Text style={styles.tableHead}>{row.childCode}</Text>
                  <div style={styles.grid}></div>
                </>
              )}
...
export default PDFTemplateCustomChild;
