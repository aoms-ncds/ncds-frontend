...
const PDFTemplateCustomSpouse = (props:any) => {
        ...
        <View style={styles.tableContainer} >
          ...
          {props.rowData?.map((row: any, index: number) => (
            <View style={styles.tableRow} key={row._id}>
              ...
              {props.headers.includes('Spouse Code') && (
                <>
                  <Text style={styles.tableHead}>{row.spouseCode}</Text>
                  <div style={styles.grid}></div>
                </>
              )}
...
export default PDFTemplateCustomSpouse;
