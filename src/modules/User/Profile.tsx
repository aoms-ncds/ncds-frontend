            ...
            <Box sx={{ width: '100%' }}>
              ...
              <TabPanel value={currentTab} index={0}>
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} lg={4}> <Typography variant='body1' component='span' sx={{ fontWeight: 'bolder' }}>Gender: </Typography> {user?.basicDetails.gender?.gender} </Grid>
                  ...
                  <Grid item xs={12} lg={4}> <Typography variant='body1' component='span' sx={{ fontWeight: 'bolder' }}>Spouse Of: </Typography> {`${user?.basicDetails.spouseOf?.basicDetails.firstName?? ''} ${user?.basicDetails.spouseOf?.basicDetails.middleName ?? ''} ${user?.basicDetails.spouseOf?.basicDetails.lastName ?? ''}`} </Grid>
                  ...
                  <Grid item xs={12} lg={4}> <Typography variant='body1' component='span' sx={{ fontWeight: 'bolder' }}>Religion: </Typography> {user?.basicDetails.religion?.religion} </Grid>
